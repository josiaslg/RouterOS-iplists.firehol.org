...
# The objective is download list from Alien Vault and
...
# Level Alien Vault
NETWORKS_TO_BLOCK_1=alienvault_reputation.ipset
NETWORKS_TO_BLOCK_ROUTEROS_1=RouterOS_AlienVault_$NETWORKS_TO_BLOCK_1
...
mv $FOLDER_TEMP/$NETWORKS_TO_BLOCK_ROUTEROS_1 ./
git add -A
